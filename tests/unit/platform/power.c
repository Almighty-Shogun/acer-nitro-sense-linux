...
int unit_run_platform_power_source_commands(struct ec_device *ec,
                                                ...
                                                bool *coolboost_enabled)
{
    ...
    if (unit_execute_command("power-source status\n", ec, cfg, states,
    ...
    if (unit_execute_command("power-source apply\n", ec, cfg, states,
                                 auto_mode, preset, preset_len,
                                 coolboost_enabled, false, reply,
                                 sizeof(reply)) < 0 ||
    ...
    if (unit_execute_command("power-source auto on\n", ec, cfg, states,
                                 auto_mode, preset, preset_len,
                                 coolboost_enabled, false, reply,
                                 sizeof(reply)) < 0 ||
        !strstr(reply, "error permission denied")) {
    ...
    if (unit_execute_command("power-source auto off\n", ec, cfg, states,
                                 auto_mode, preset, preset_len,
                                 coolboost_enabled, true, reply,
                                 sizeof(reply)) < 0 ||
